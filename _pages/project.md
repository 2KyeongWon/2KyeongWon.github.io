...
'재고 관리'
많은 프로그램이 있지만 복잡하고 사용하기 어려운 느낌을 받았기 때문에
간단하고 손쉽게 재고를 관리할 수 있는 웹사이트를 만들게 되었습니다

저희가 구현하고자 하는 기능은 jQuery, ajax 필요하여
부족했던 공부를 하며 프로젝트를 진행할 수 있어 더욱더 만족스럽습니다

> 향후 구현 예정

입고 출고를 통해 얻은 가격과 날짜를 이용하여
한달 입고 비용, 한달 매출을 구하기, 그래프 이용하기

> 깃허브 프로젝트

<a href="https://github.com/2KyeongWon/spring_project">
    프로젝트 바로 이동 
</a>
